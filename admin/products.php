                ...
                <?php foreach ($products as $product): 
                    ...
                    if (!empty($product['image_url'])) {
                        if (strpos($product['image_url'], 'tmp_uploads/') === 0) {
                            // Image is stored in /tmp, use serve_image script
                            $productImage = 'admin/serve_image.php?file=' . urlencode(basename($product['image_url']));
                        } elseif (file_exists($product['image_url'])) {
                            // Regular upload, check if file exists
                ...
                ?>
                    <div class="product-card">
                        <div class="product-image">
                            ...
                            <?php endif; ?>
                        </div>dee2e6; width: 100%; height: 100%; align-items: center; justify-content: center;">
                                    <?php echo $fallbackIcon; ?>
                                </div>
                            <?php else: ?>
                                <div class="fallback-icon" style="font-size: 48px; color: #dee2e6;">
