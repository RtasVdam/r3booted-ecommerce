...
function handleImageUpload($file) {
    // Use absolute path from admin directory
    ...
    if (!is_writable($uploadDir)) {
        throw new Exception('Upload directory is not writable. Directory: ' . $uploadDir);
    }
    ...
    if (move_uploaded_file($file['tmp_name'], $filepath)) {
        ...
        throw new Exception('Failed to upload image. Check file permissions. Upload dir: ' . $uploadDir);
    }
}
...
<body>
    ...
    <div class="container">
        ...
        $message = getMessage();
        if ($message): ?>
            <div class="notification <?php echo $message['type']; ?>" style="position: relative; transform: none; margin-bottom: 20px;">
